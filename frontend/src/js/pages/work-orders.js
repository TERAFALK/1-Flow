...
// Själva ritandet ligger i components/gantt.js sedan Försäljning behövde samma
// schema. Här hämtas bara faserna och mappas till komponentens format.
...
async function loadOverviewGantt(orderId) {
  ...
  renderGantt(container, {
    ...
    pdfUrl: `/work-orders/${orderId}/gantt/pdf`,
    pdfName: `gantt-order-${orderId}.pdf`,
    emptyHtml: `
